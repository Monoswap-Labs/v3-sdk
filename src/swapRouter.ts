...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@monoswap-labs/sdk-core'
...
/**
 * Represents the Monoswap V3 SwapRouter, and has static methods for helping execute trades.
 */

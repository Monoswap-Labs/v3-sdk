...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@monoswap-labs/sdk-core'
...
/**
 * Represents the Monoswap V3 QuoterV1 contract with a method for returning the formatted
